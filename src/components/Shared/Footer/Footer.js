...
const Footer = () => {
    return (
        <div className='px-10 md:px-20 py-10 bg-black text-gray-200 font-serif'>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 justify-between text-left'>
                <div>
                    ...
                    <ul>
                        ...
                        <li className='mb-4 flex items-center'><MdAlternateEmail className='text-2xl mr-3' /><span>bookcloset@gmail.com<br />support@gmail.com</span></li>
